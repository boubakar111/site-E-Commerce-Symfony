...
class Product
{
    ...
    public function getMorInformation(): ?string
    {
        return $this->morInformation;
    }

    public function setMorInformation(?string $morInformation): self
    {
        $this->morInformation = $morInformation;
    ...
    public function getIsNewArival(): ?bool
    {
