 ...
 */
final class Version20210907082305 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE "panier" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, reference VARCHAR(255) NOT NULL, full_name VARCHAR(255) NOT NULL, transproteur_name VARCHAR(255) NOT NULL, transport_price DOUBLE PRECISION NOT NULL, adresse_livraison CLOB NOT NULL, is_paid BOOLEAN NOT NULL, more_informations CLOB DEFAULT NULL, created_at DATETIME NOT NULL, quantity INTEGER NOT NULL, sub_total_ht DOUBLE PRECISION NOT NULL, taxe DOUBLE PRECISION NOT NULL, sub_total_ttc DOUBLE PRECISION NOT NULL)');
        $this->addSql('CREATE INDEX IDX_24CC0DF2A76ED395 ON "panier" (user_id)');
        $this->addSql('CREATE TABLE "panierDetails" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, paniers_id INTEGER NOT NULL, product_name VARCHAR(255) NOT NULL, product_price DOUBLE PRECISION NOT NULL, quantity INTEGER NOT NULL, sub_total_ht DOUBLE PRECISION NOT NULL, taxe DOUBLE PRECISION NOT NULL, sub_total_ttc DOUBLE PRECISION NOT NULL)');
        $this->addSql('CREATE INDEX IDX_F151378BBE35FDA0 ON "panierDetails" (paniers_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__order AS SELECT id, user_id, reference, full_name, transproteur_name, transport_price, adresse_livraison, more_informations, created_at, quantity, sub_total_ht, taxe, sub_total_ttc, is_paid FROM "order"');
        $this->addSql('DROP TABLE "order"');
        $this->addSql('CREATE TABLE "order" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, reference VARCHAR(255) NOT NULL COLLATE BINARY, full_name VARCHAR(255) NOT NULL COLLATE BINARY, transproteur_name VARCHAR(255) NOT NULL COLLATE BINARY, transport_price DOUBLE PRECISION NOT NULL, adresse_livraison CLOB NOT NULL COLLATE BINARY, more_informations CLOB DEFAULT NULL COLLATE BINARY, created_at DATETIME NOT NULL, quantity INTEGER NOT NULL, sub_total_ht DOUBLE PRECISION NOT NULL, taxe DOUBLE PRECISION NOT NULL, sub_total_ttc DOUBLE PRECISION NOT NULL, is_paid BOOLEAN NOT NULL, CONSTRAINT FK_F5299398A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO "order" (id, user_id, reference, full_name, transproteur_name, transport_price, adresse_livraison, more_informations, created_at, quantity, sub_total_ht, taxe, sub_total_ttc, is_paid) SELECT id, user_id, reference, full_name, transproteur_name, transport_price, adresse_livraison, more_informations, created_at, quantity, sub_total_ht, taxe, sub_total_ttc, is_paid FROM __temp__order');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE "panierDetails"');
        $this->addSql('DROP INDEX IDX_EF192552A76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__adresses AS SELECT id, user_id, full_name, company, adresse, compl_adresse, city, code_postal, pays, telephone FROM adresses');
        $this->addSql('DROP TABLE adresses');
        ...
        $this->addSql('CREATE INDEX IDX_EF192552A76ED395 ON adresses (user_id)');
        $this->addSql('DROP INDEX IDX_F5299398A76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__order AS SELECT id, user_id, reference, full_name, transproteur_name, transport_price, adresse_livraison, is_paid, more_informations, created_at, quantity, sub_total_ht, taxe, sub_total_ttc FROM "order"');
        $this->addSql('DROP TABLE "order"');
        $this->addSql('CREATE TABLE "order" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, reference VARCHAR(255) NOT NULL, full_name VARCHAR(255) NOT NULL, transproteur_name VARCHAR(255) NOT NULL, transport_price DOUBLE PRECISION NOT NULL, adresse_livraison CLOB NOT NULL, is_paid BOOLEAN NOT NULL, more_informations CLOB DEFAULT NULL, created_at DATETIME NOT NULL, quantity INTEGER NOT NULL, sub_total_ht DOUBLE PRECISION NOT NULL, taxe DOUBLE PRECISION NOT NULL, sub_total_ttc DOUBLE PRECISION NOT NULL)');
        $this->addSql('INSERT INTO "order" (id, user_id, reference, full_name, transproteur_name, transport_price, adresse_livraison, is_paid, more_informations, created_at, quantity, sub_total_ht, taxe, sub_total_ttc) SELECT id, user_id, reference, full_name, transproteur_name, transport_price, adresse_livraison, is_paid, more_informations, created_at, quantity, sub_total_ht, taxe, sub_total_ttc FROM __temp__order');
        $this->addSql('DROP TABLE __temp__order');
        $this->addSql('CREATE INDEX IDX_F5299398A76ED395 ON "order" (user_id)');
        $this->addSql('DROP INDEX IDX_3C78ADFACFFE9AD6');
        $this->addSql('CREATE TEMPORARY TABLE __temp__order_detaiils AS SELECT id, orders_id, product_name, product_price, quantity, sub_total_ht, taxe, sub_total_ttc FROM order_detaiils');
