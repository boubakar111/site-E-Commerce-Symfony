 ...
 */
final class Version20210906193414 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO "order" (id, user_id, reference, full_name, transproteur_name, transport_price, adresse_livraison, is_paider, more_informations, created_at, quantity, sub_total_ht, taxe, sub_total_ttc) SELECT id, user_id, reference, full_name, transproteur_name, transport_price, adresse_livraison, is_paider, more_informations, created_at, quantity, sub_total_ht, taxe, sub_total_ttc FROM __temp__order');
